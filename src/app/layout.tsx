...
export const metadata: Metadata = {
  title: "ZASTÁVKA - Kavárna v Příbrami | Kvalitní Káva a Snídaně",  description: "Moderní kavárna s výbornou kávou, skvělými snídaněmi a domácím pečivem. Parkování ve dvoře, milý personál. Navštivte nás na Mariánské 135 v Příbrami.",  keywords: "kavárna Příbram, kvalitní káva, snídaně, pečivo, restaurace, parkování",  metadataBase: new URL("https://zastavka-pribram.cz"),
  alternates: {
    canonical: "https://zastavka-pribram.cz"},
  openGraph: {
    title: "ZASTÁVKA - Vaše Nejchutnější Zastávka v Příbrami",    description: "Zastavte se na výbornou kávu, skvělé snídaně a domácí pečivo. Čisté, útulné a moderní prostředí.",    url: "https://zastavka-pribram.cz",    siteName: "ZASTÁVKA Kavárna",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/table-chairs-bar_107420-65857.jpg",        alt: "ZASTÁVKA - Moderní kavárna v Příbrami"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "ZASTÁVKA - Moderní Kavárna v Příbrami",    description: "Kvalitní káva, skvělé snídaně a příjemné prostředí. Parkování ve dvoře.",    images: ["http://img.b2bpic.net/free-photo/table-chairs-bar_107420-65857.jpg"],
  },
  robots: {
    index: true,
    follow: true,
